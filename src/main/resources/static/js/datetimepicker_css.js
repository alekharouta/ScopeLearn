...
var TodayColor="#DCDCDC";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#DCDCDC";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#DCDCDC"; //color when mouse move over.
var ThemeBg="";//Background image of Calendar window.
var CalBgColor="red";//Backgroud color of Calendar window.
